    ...
    return (
        <div className='main-banner'>
            ...
            <div className="content space-y-5">
                <h1 className='text-5xl text-white font-semibold uppercase'>Welcome to my Website</h1>
                ...
                <button className='btn border-2 border-green-800  duration-400 hover:bg-green-800 bg-transparent px-5 p-1' onClick={()=> console.log('hello')}>Travel Now</button>
            </div>
